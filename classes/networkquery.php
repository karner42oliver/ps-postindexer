...
function network_is_archive() {
	...
	if ( ! isset( $network_query ) ) {
		_doing_it_wrong( __FUNCTION__, __( 'Bedingte Abfragetags funktionieren nicht, bevor die Abfrage ausgeführt wird. Vorher geben sie immer false zurück.' ), '3.1' );
		return false;
	}
 ...
 * @uses $wp_query
 *
 * @param mixed $post Beitrag ID, title, slug, or array of such.
 * @return bool
 */
